...
def register_urls():
    ...
    return UrlHook(
        ...
        excluded_views=[
            ...
            "aa_eveaio.views.api_capabilities",
            "aa_eveaio.views.api_roaming_manifest",
            "aa_eveaio.views.api_roaming_blobs",
            "aa_eveaio.views.api_roaming_blob",
            "aa_eveaio.views.api_roaming_records",
            "aa_eveaio.views.api_roaming_record",
        ],
    )
