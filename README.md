...
## Roaming Profile (v1.1.0+)

Users can optionally sync their **EVEAIO Roaming Profile** via Alliance
Auth — no third-party cloud storage required. In the desktop app:
Settings → Sync & Data → Roaming Profile → **Alliance Auth**.

Requires EVEAIO desktop v2.3.124+.
